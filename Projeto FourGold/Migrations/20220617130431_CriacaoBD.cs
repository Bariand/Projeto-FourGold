    ...
    public partial class CriacaoBD : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tbl_Conta", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Tbl_Conta_ContaId",
                        column: x => x.ContaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tbl_ChavePix", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tbl_ChavePix_Tbl_Conta_ContaId",
                        column: x => x.ContaId,
                        principalTable: "Tbl_Conta",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
